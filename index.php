...
<body>
	<nav class="navbar-nav navbar-expand-sm bg-dark">
		<div class="nav-item item1" style="margin-left:5%">
			<h2 onclick='window.location.reload();' style="cursor:pointer;font-family: 'Poppins', sans-serif;font-weight:bold;">Complaint Management System</h2>
		</div>
	...
	<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item active">
				<img src="admin.jpeg" style="object-fit:contain;" alt="Los Angeles" width="800px" height="800px">
			</div>
		</div>
